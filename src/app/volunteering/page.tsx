...
const StoryImage=({src,alt}:{src:string;alt:string})=><figure className="story-image"><div><Image src={src} alt={alt} fill sizes="(max-width:900px) 100vw, 50vw"/></div></figure>;
...
<StoryImage src={photos[0]} alt="Volunteers taking part in a Women’s Voices community session"/>
...
<StoryImage src={photos[1]} alt="Women volunteering together"/>
<section className="content-section split-content"><div><span className="content-number">03</span><h2>PART OF THE COMMUNITY</h2></div><div className="prose"><p>Volunteering creates opportunities to contribute, meet people, develop experience and help other women feel welcome and supported.</p></div></section>
<div className="story-image-row story-image-row--two">{photos.slice(2).map((src,i)=><figure className="story-image story-image--small" key={src}><div><Image src={src} alt={["Community volunteers at Women’s Voices","Women’s Voices volunteers and community members"][i]} fill sizes="(max-width:900px) 100vw, 50vw"/></div></figure>)}</div>

...
const activities = [
  { ...programmes[0], description: "We offer practical learning opportunities that build confidence, communication, wellbeing, rights awareness and enterprise skills." },
  { ...programmes[1], description: "Volunteers share skills, support drop-in sessions, raise the profile of Women’s Voices CIC and help organise events." },
  { ...programmes[2], description: "We provide a safe, accessible space where women can meet, learn, build resilience and strengthen their independence." },
];
